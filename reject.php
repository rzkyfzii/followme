                    ...
                    <form method="GET" class="mb-3">
                      ...
                      <table id="datatablesSimple" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $ambilsemuadatastock = mysqli_query($conn, "SELECT * FROM reject $searchQuery");
                            $i = 1;
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="hapusbarangproduksia">Hapus</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
...
<div class="modal fade" id="myModal">
  ...
  <label for="asalproduksi">Pilih Produksi</label>
  <select class="form-control" name="asalproduksi" required>
    ...
    <option value="produksi_d">Produksi D</option>
          ...
          <div class="modal-footer">
            <button type="submit" name="reject" class="btn btn-primary">Simpan</button>
          </div>
        </form>
      </div>
