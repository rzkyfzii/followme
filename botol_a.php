...
<h2>Stok Barang Botol - Gudang A</h2>
        ...
        <div class="container-fluid px-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="export.php?botol_a" class="btn btn-danger" target="_blank">
                    <i class="bi bi-file-earmark-pdf"></i> Export PDF
                      ...
                      <table id="datatablesSimple" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $ambilsemuadatastock = mysqli_query($conn, "SELECT * FROM botol_a $searchQuery");
                            $i = 1;
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <button type="submitC" class="btn btn-primary" name="updatebarangbotol">Submit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="idb" value="<?= $idb; ?>">
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="hapusbarangbotol">Hapus</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
      ...
      <div class="modal-body">
        <form method="POST" class="custom-form">
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              <label for="botol">Botol</label>
              <input type="number" class="form-control" name="botol"  required>
            </div>
          <!-- Modal Footer -->
          <div class="modal-footer">
            <button type="submit" name="submitbotol" class="btn btn-primary">Simpan</button>
          </div>
        </form>
      </div>
