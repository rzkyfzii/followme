                    ...
                    <form method="GET" class="mb-3">
                      ...
                      <table id="datatablesSimple" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $ambilsemuadatastock = mysqli_query($conn, "SELECT * FROM produksi_c $searchQuery");
                            $i = 1;
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="hapusbarangproduksic">Hapus</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
