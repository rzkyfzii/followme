                    ...
                    <form method="GET" class="mb-3">
                      ...
                      <table id="datatablesSimple" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $ambilsemuadatastock = mysqli_query($conn, "SELECT * FROM produksi_d $searchQuery");
                            $i = 1;
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="hapusbarangproduksid">Hapus</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
      ...
      <div class="modal-body">
        <form method="POST" class="custom-form">
          ...
          <div class="modal-footer">
            <button type="submit" name="D" class="btn btn-primary">Simpan</button>
          </div>
        </form>
      </div>
