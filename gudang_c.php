                    ...
                    <i class="bi bi-file-earmark-pdf"></i> Export PDF
                      ...
                      <table id="datatablesSimple" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            $ambilsemuadatastock = mysqli_query($conn, "SELECT * FROM gudangc $searchQuery");
                            $i = 1;
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <button type="submitC" class="btn btn-primary" name="updatebarangc">Submit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="idb" value="<?= $idb; ?>">
                                                    <br>
                                                    <button type="submit" class="btn btn-danger" name="hapusbarangc">Hapus</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
      ...
      <div class="modal-body">
        <form method="POST" class="custom-form">
          ...
          <div class="modal-footer">
            <button type="submitC" name="submitC" class="btn btn-primary">Simpan</button>
          </div>
        </form>
      </div>
